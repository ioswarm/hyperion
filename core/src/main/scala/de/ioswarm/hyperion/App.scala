...
trait App {
  ...
  def main(args: Array[String]): Unit = {
    ...
    _config = ConfigFactory.parseString(seeds
      ...
      .withFallback(ConfigFactory.parseString(s"hyperion.http.hostname=$clusterHostname"))
      .withFallback(ConfigFactory.parseString(s"hyperion.http.port=$clusterPort"))
